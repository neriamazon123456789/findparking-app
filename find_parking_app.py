...
כתובות_כחול_לבן = [f"משה דיין {x} תל אביב" for x in range(1, 86) if x not in [15,17,19,3,4,6,8,9,12,13,20,33]]
...
# אתחול session_state לטיימר – שמירה גם אחרי בדיקות
