...
# ✅ נירמול כתובת – כדי ש"יפו" תמיד תיחשב כתל אביב
...
# === עדכון אם נבחרה כתובת מהיסטוריה
...
with col2:
    st.markdown(
        f"[📩 שלח במייל](mailto:?subject=מצאתי%20אפליקציה%20למצוא%20חניה!&body={קישור})",
        unsafe_allow_html=True
    )
with col3:
